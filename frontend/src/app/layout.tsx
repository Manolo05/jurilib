...
export const metadata: Metadata = {
  ...
  title: { default: 'Jurilib \u2014 Prenez rendez-vous avec un avocat', template: '%s | Jurilib' },
  description: 'Jurilib connecte clients et avocats inscrits au barreau.',
        ...
        <header className="sticky top-0 z-50 bg-juri-bg/60 backdrop-blur-2xl border-b border-juri-border/50">
          <div className="mx-auto max-w-6xl flex items-center justify-between px-4 py-4">
            <Link href="/" className="flex items-center gap-3 group">
              ...
              <span className="font-serif text-xl tracking-tight text-juri-text group-hover:text-gold transition-colors">Jurilib</span>
            </Link>
        ...
        <footer className="mt-24 border-t border-juri-border">
          <div className="mx-auto max-w-6xl px-4 py-12 grid md:grid-cols-4 gap-8 text-sm">
            <div>
              ...
              <p className="mt-3 text-juri-muted">La plateforme qui connecte clients et avocats en France.</p>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="mt-3 space-y-2 text-juri-muted">
                <li><Link href="/mentions-legales" className="hover:text-gold transition-colors">Mentions legales</Link></li>
                <li><Link href="/cgu" className="hover:text-gold transition-colors">CGU</Link></li>
                <li><Link href="/politique-de-confidentialite" className="hover:text-gold transition-colors">Confidentialite</Link></li>
              </ul>
            </div>
            <div>
              <h3 className="font-serif text-juri-text">Contact</h3>
              <ul className="mt-3 space-y-2 text-juri-muted">
                <li><a href="mailto:contact@jurilib.fr" className="hover:text-gold transition-colors">contact@jurilib.fr</a></li>
              </ul>
            </div>
          </div>
          <div className="border-t border-juri-border">
            <p className="mx-auto max-w-6xl px-4 py-6 text-xs text-juri-muted text-center">2026 Jurilib - Plateforme independante</p>
          </div>
        </footer>
        <CookieBanner />
      </body>
      ...
      <body className="min-h-screen bg-juri-bg text-juri-text font-sans antialiased flex flex-col">
        ...
        <header className="sticky top-0 z-50 bg-juri-bg/60 backdrop-blur-2xl border-b border-juri-border/50">
          <div className="mx-auto max-w-6xl flex items-center justify-between px-4 py-4">
            ...
            <nav className="flex items-center gap-6 text-sm">
              <Link href="/recherche" className="font-sans text-juri-muted hover:text-gold transition-colors">
                Trouver un avocat
              </Link>
              <Link href="/avocat-inscription" className="font-sans text-juri-muted hover:text-gold transition-colors">
                Je suis avocat
              </Link>
              <Link href="/login"
